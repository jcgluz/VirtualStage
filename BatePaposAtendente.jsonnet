...
#               pergunta/resposta do ator atendente
...
[
   ...
   {    "hear":     ["<eu><gosto><de><m.sica>(<.+>+)"],
        "talk":     ["Então você gosta de ouvir música {0}?",
                    "Que interessante que você gosta de música {0}",
                    "Não sabia que você gosta de música {0}"]
        
   },
   {    "hear":     ["<eu><gosto><de><ler>(<.+>+)"],
        "talk":     ["Interessante que você gosta de ler {0}",
                    "Ler é importante",
                    "Não sabia que você gostava de ler {0}"]
   },
   {    "hear":     ["<hoje>?<estou><cansad.|exaust.|meio|chatead.><com>?<fraco|sono>_"],
        "talk":     ["É o dia está meio pesado mesmo",
                    "Você deve estar trabalhando demais",
                    "Tente descansar um pouco",
                    "É hoje está um dia bastante complicado"]
   },
   {    "hear":     ["<hoje>?<o>?<dia><est.|tá|ta><pesado|cansativo|chato>_"],
        "talk":     ["É o dia está meio pesado mesmo",
                    "Você deve estar trabalhando demais",
                    "Tente descansar um pouco",
                    "É hoje está um dia bastante complicado"]
   },
   {    "hear":     ["<tem>?<muito|bastante><trabalho><hoje>_",
                    "<voc.|tu>?<tá|ta|est.*>?<trabalhando><bastante|muito>_"],
        "talk":     ["Sim tem muito trabalho",
                    "Sempre tem bastante trabalho",
                    "Sim estou trabalhando bastante",
                    "Sim sempre tem trabalho",
                    "É trabalho não falta",
                    "Sim muito atarefado hoje"]
   },
   {    "hear":     ["<ser.><que><vai><chover|esfriar><hoje>_",
                    "<est.|ta|t.a><frio|quente|chovendo>_"],
        "talk":     ["Não sei, quase não olho pra fora",
                    "O tempo é sempre louco",
                    "Pode ser, o tempo aqui é complicado",
                    "Mas acho que vai melhorar",
                    "O tempo sempre muda",
                    "Sim acho que vai continuar assim"]
   },
   {    "hear":     ["<tudo><bem|bom|tranquilo><com><você>_",
                    "<tudo><bem|bom|tranquilo><contigo>_",
                    "<tu|voc.>?<est.*|ta|tá><bem|tranquilo>_"],
        "talk":     ["Sim tudo bem",
                    "Tudo tranquilo meu caro",
                    "Sim sim tudo bem",
                    "Hoje está tudo bem",
                    "Tudo bem por agora",
                    "Claro que sim, tudo tranquilo"]
   },
   {    "hear":     ["<quem><é><que><te><criou>",
                    "<quem><é><teu|seu|tua|sua><pai|m.e|criador|criadora>"],
        "talk":     ["Meu criador é {dcharacter-creator}",
                    "Sou um personagem digital criado por {dcharacter-creator}",
                    "Fui criado por {dcharacter-creator}"]
   },
   ...
   {    "hear":     ["<meu><pai><é>(<.+>+)<quem><é><seu|teu><pai>"],
        "talk":     "O seu pai é {0}, mas meu criador é {actor-creator}"
   }
   {    "hear":     ["<.*>*"],
        "talk":     ["Sou {character-name} o atendente aqui, não entendi o que você falou",
                    "Pode me chamar de {character-name}, não te entendi, o que você precisa?",
                    "Eu sou {character-name} e atendo aqui, o que você quer?",
                    "Me chamo {character-name}, sou recepcionista aqui, o que você precisa?",
                    "Sou {character-name} e faço a recepção aqui, o que precisa?"]
   }
 ]
